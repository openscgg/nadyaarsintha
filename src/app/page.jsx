...
export default function Home() {
  ...
  return (
    <>
      <nav className=" bg-neutral-950 z-10 w-full px-8 py-4 flex items-center justify-between">
        <div className="relative md:absolute flex md:justify-center  w-full">
          <div>
      ...
      <section className="relative bg-[url('/images/nadya-medium-closeup.jpeg')] bg-cover bg-[100%_17%] h-screen w-full flex items-center">
        <div className="absolute inset-0 bg-black/80"></div>

        <div className="relative z-10 container flex flex-col justify-center items-center px-6 py-20 mx-auto max-w-6xl">
          <motion.h1
      ...
      text-4xl sm:text-5xl md:text-6xl text-white"
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            className="text-center text-base sm:text-lg md:text-xl max-w-2xl text-neutral-200"
          >
      ...
      <footer className="relative bg-neutral-950 py-6">
        <p className="text-neutral-500 text-center text-sm">
          &copy; {new Date().getFullYear()} Nadya Arsintha. All rights reserved.
        </p>
      </footer>
    </>
  );
